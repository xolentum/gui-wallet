export default {
  ...
  menuItems: {
    ...
    exit: "Cerrar la interfaz del monedero Xolentum",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "xolentumd no encontrado, utilizando nodo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    xolentumUnlockedBalance: "Saldo libre",
    xolentumUnlockedShort: "Libre",
